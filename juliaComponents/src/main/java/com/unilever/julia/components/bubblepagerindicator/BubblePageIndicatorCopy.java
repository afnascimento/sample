...
public class BubblePageIndicatorCopy extends MotionIndicator {
    ...
    public BubblePageIndicatorCopy(Context context) {
        this(context, null);
    }

    public BubblePageIndicatorCopy(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.bpi_indicatorStyle);
    }

    public BubblePageIndicatorCopy(Context context, AttributeSet attrs, int defStyle) {

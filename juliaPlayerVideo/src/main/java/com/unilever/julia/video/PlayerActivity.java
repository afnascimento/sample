...
public class PlayerActivity extends AppCompatActivity
    ...
    private IExoPlayerManager mExoPlayerManager;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mExoPlayerManager = ((IExoPlayerApplication) getApplication()).getExoPlayerManager();
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            RenderersFactory renderersFactory = mExoPlayerManager.buildRenderersFactory(preferExtensionDecoders);
    ...
    private MediaSource buildMediaSource(Uri uri, @Nullable String overrideExtension) {
        DownloadRequest downloadRequest = mExoPlayerManager.getDownloadTracker().getDownloadRequest(uri);
    ...
    private DefaultDrmSessionManager<FrameworkMediaCrypto> buildDrmSessionManagerV18(
        ...
        HttpDataSource.Factory licenseDataSourceFactory = mExoPlayerManager.buildHttpDataSourceFactory();
    ...
    private DataSource.Factory buildDataSourceFactory() {
        return mExoPlayerManager.buildDataSourceFactory();
    }

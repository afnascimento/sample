...
public class CurrencyEditText extends AppCompatEditText {
    ...
    private void writeLog(Throwable e) {
        Logger.INSTANCE.debug("CurrencyEditText", e.getMessage());
    }
    ...
    public void setValue(double value) {
        mIsFormatDivide = false;
        this.setText(format(Double.valueOf(value).toString()), TextView.BufferType.EDITABLE);
    }
    ...
    private boolean mIsFormatDivide = true;
    ...
    private String format(String text) {
        if (mShowSymbol) {
            ...
            if (mIsFormatDivide) {
                ...
                mIsFormatDivide = true;
                return numberFormat.format(Double.parseDouble(text)).replace(currencySymbol, "");
            }
        }
    }
